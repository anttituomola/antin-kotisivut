...
<aside class="not-prose my-8 rounded-xl border border-primary/30 bg-primary/10 p-5 text-text-primary">
  ...
  <p class="m-0 text-lg font-medium">When you're improving anything, whether a work process, software, or even a relationship, the same rules apply: be active, involved, and interested. Things start getting better almost by themselves.</p>
</aside>
