...
Along the way it noticed from Stripe payment data that, due to an old bug, I had been double-billing one customer for months. I refunded the money, so this code review immediately paid for itself by hundreds of euros.
